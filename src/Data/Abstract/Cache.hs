...
newtype Cache term location value = Cache { unCache :: Monoidal.Map (Configuration term location value) (Set (value, Heap (Cell location) location value)) }
  deriving (Lower)
...
deriving instance (Cacheable term location value, cell ~ Cell location) => Reducer (Configuration term location value, (value, Heap cell location value)) (Cache term location value)

-- | Look up the resulting value & 'Heap' for a given 'Configuration'.
cacheLookup :: Cacheable term location value => Configuration term location value -> Cache term location value -> Maybe (Set (value, Heap (Cell location) location value))
...
cacheSet :: Cacheable term location value => Configuration term location value -> Set (value, Heap (Cell location) location value) -> Cache term location value -> Cache term location value
...
cacheInsert :: Cacheable term location value => Configuration term location value -> (value, Heap (Cell location) location value) -> Cache term location value -> Cache term location value
