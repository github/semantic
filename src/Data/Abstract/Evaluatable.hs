...
data EvalError term address value return where
  QualifiedImportError :: ImportPath -> EvalError term address value (ValueRef address value)
  DerefError :: value -> EvalError term address value (ValueRef address value)
  ...
  ReferenceError      :: value -> Name -> EvalError term address value (ValueRef address value)
  ConstructorError    :: Name -> EvalError term address value address
  ScopedEnvError      :: value -> EvalError term address value address

deriving instance (Eq term, Eq address, Eq value) => Eq (EvalError term address value return)
deriving instance (Show term, Show address, Show value) => Show (EvalError term address value return)
...
instance (Show term, Show address, Show value) => Show1 (EvalError term address value) where
