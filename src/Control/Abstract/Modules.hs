...
lookupModule :: forall address value effects . Member (Modules address value) effects => ModulePath -> Evaluator address value effects (Maybe (Maybe (Environment address, address)))
lookupModule = send . Lookup @address @value
...
load :: forall address value effects . Member (Modules address value) effects => ModulePath -> Evaluator address value effects (Maybe (Environment address, address))
load = send . Load @address @value


data Modules address value return where
  Load    :: ModulePath -> Modules address value (Maybe (Environment address, address))
  Lookup  :: ModulePath -> Modules address value (Maybe (Maybe (Environment address, address)))
