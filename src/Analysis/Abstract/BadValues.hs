...
deriving instance MonadControl term effects m                    => MonadControl term effects (BadValues m)
deriving instance MonadEnvironment location value effects m      => MonadEnvironment location value effects (BadValues m)
