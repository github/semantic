...
instance ( Effectful (m term value)
  ...
  type RequiredEffects term value (Collecting m term value effects) rest = RequiredEffects term value (m term value effects) (Reader (Live (LocationFor value) value) ': rest)
