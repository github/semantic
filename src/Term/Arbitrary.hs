...
unArbitraryTerm :: ArbitraryTerm leaf annotation -> SyntaxTermF leaf annotation (ArbitraryTerm leaf annotation)
unArbitraryTerm (ArbitraryTerm a s) = a :< s

toTerm :: ArbitraryTerm leaf annotation -> SyntaxTerm leaf annotation
...
type instance Base (ArbitraryTerm leaf annotation) = SyntaxTermF leaf annotation
