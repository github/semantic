...
graphImports package = analyze importGraphAnalysis (evaluatePackageWith (providingCurrentModule . graphingModules) (providingCurrentTerm . graphingTerms) package) >>= extractGraph
  where
