...
expressionStatement :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
dottedName :: HasCallStack => Assignment Grammar (Term Syntax Location)
dottedName = makeTerm <$> symbol DottedName <*> children (Expression.ScopeResolution <$> many expression)

ellipsis :: HasCallStack => Assignment Grammar (Term Syntax Location)
ellipsis = makeTerm <$> symbol Grammar.Ellipsis <*> (Language.Python.Syntax.Ellipsis <$ source)

comparisonOperator :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
binaryOperator :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
booleanOperator :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
augmentedAssignment :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
yield :: HasCallStack => Assignment Grammar (Term Syntax Location)
yield = makeTerm <$> symbol Yield <*> (Statement.Yield <$> children ( expression <|> expressionList <|> emptyTerm ))

rvalue :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
set :: HasCallStack => Assignment Grammar (Term Syntax Location)
set = makeTerm <$> symbol Set <*> children (Literal.Set <$> many expression)

dictionary :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
list' :: HasCallStack => Assignment Grammar (Term Syntax Location)
list' = makeTerm <$> symbol List <*> children (Literal.Array <$> many expression)

-- TODO: Wrap `Literal.TextElement` with a `Literal.String`
string :: HasCallStack => Assignment Grammar (Term Syntax Location)
string = makeTerm <$> symbol String <*> (Literal.TextElement <$> source)

concatenatedString :: HasCallStack => Assignment Grammar (Term Syntax Location)
concatenatedString = makeTerm <$> symbol ConcatenatedString <*> children (Literal.TextElement . mconcat <$> many (symbol String *> source))

float :: HasCallStack => Assignment Grammar (Term Syntax Location)
float = makeTerm <$> symbol Float <*> (Literal.Float <$> source)

integer :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
import' :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
importFrom :: HasCallStack => Assignment Grammar (Term Syntax Location)
importFrom = makeTerm <$> symbol ImportFromStatement <*> children (Declaration.Import <$> many expression)

assertStatement :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
printStatement :: HasCallStack => Assignment Grammar (Term Syntax Location)
printStatement = do
...
globalStatement :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
comprehension :: HasCallStack => Assignment Grammar (Term Syntax Location)
...
conditionalExpression :: HasCallStack => Assignment Grammar (Term Syntax Location)
