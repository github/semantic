...
resolveGoImport :: forall value term location effects m. (Member Fail effects, MonadEvaluatable location term value effects m) => ImportPath -> m effects [ModulePath]
