public enum JSON: ArrayLiteralConvertible, BooleanLiteralConvertible, Equatable, FloatLiteralConvertible, IntegerLiteralConvertible, JSONConvertible, StringLiteralConvertible {
