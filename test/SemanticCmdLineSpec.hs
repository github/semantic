...
instance Listable ParseFixture where
  tiers = cons0 (ParseFixture (sExpressionParseTree pathMode "" []) sExpressionParseTreeOutput)
       ...
       \/ cons0 (ParseFixture (jsonIndexParseTree False commitMode repo []) "[{\"filePath\":\"methods.rb\",\"programNode\":[{\"category\":\"Method\",\"identifier\":\"foo\",\"range\":[0,11],\"sourceSpan\":{\"start\":[1,1],\"end\":[2,4]}}]},[]]\n")
