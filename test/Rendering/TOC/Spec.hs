...
type Diff' = Diff ListableSyntax (Maybe Declaration, Location) (Maybe Declaration, Location)
type Term' = Term ListableSyntax (Maybe Declaration, Location)
...
programInfo :: (Maybe Declaration, Location)
programInfo = (Nothing, emptyInfo)

emptyInfo :: Location
emptyInfo = Location (Range 0 0) (Span (Pos 0 0) (Pos 0 0))
...
blankDiff = merge (arrayInfo, arrayInfo) (inject [ inserting (termIn literalInfo (inject (Syntax.Identifier (name "\"a\"")))) ])
  where
    arrayInfo = (Nothing, Location (Range 0 3) (Span (Pos 1 1) (Pos 1 5)))
    literalInfo = (Nothing, Location (Range 1 2) (Span (Pos 1 2) (Pos 1 4)))
...
diffWithParser :: ( Eq1 syntax
               ...
               -> BlobPair
               -> Eff effs (Diff syntax (Maybe Declaration, Location) (Maybe Declaration, Location))
