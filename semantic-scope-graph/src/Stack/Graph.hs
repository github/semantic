...
data Node
  = Root {symbol :: Symbol}
  | Declaration {symbol :: Symbol, syntaxType :: P.SyntaxType, location :: Loc}
  | Reference {symbol :: Symbol, syntaxType :: P.SyntaxType, location :: Loc}
...
reference :: Symbol -> P.SyntaxType -> Loc -> Graph Node
